...
public class PriceHistoryController {
    ...
    @GetMapping("/{id}")
    public PriceHistoryWithCarModelBrandDTO getByIdUserWithRoles(
    ...
    public List<PriceHistoryWithCarModelBrandDTO>
    findByNotNullPriceHistoryWithCarModelBrandDTO(
    ...
    public List<PriceHistoryWithCarModelBrandDTO>
    findByNullPriceHistoryWithCarModelBrandDTO(
            @RequestParam("field") List<String> fields) {
    ...
    public List<PriceHistoryWithCarModelBrandDTO>
    findLessThanPriceHistoryWithCarModelBrandDTO(
    ...
    public List<PriceHistoryWithCarModelBrandDTO>
    findGreaterThanPriceHistoryWithCarModelBrandDTO(
            @RequestParam Map<String, Number> fieldNumberMap) {
    ...
    public List<PriceHistoryWithCarModelBrandDTO>
    findContainPriceHistoryWithCarModelBrandDTO(
