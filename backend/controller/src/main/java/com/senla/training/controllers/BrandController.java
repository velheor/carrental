...
public class BrandController {
    ...
    @GetMapping("/{id}")
    public BrandWithModelsDTO getByIdUserWithRoles(
    ...
    public List<BrandWithModelsDTO> sortWithDirectionUsersWithRoles(
        ...
        return brandService.findAllAndSortWithDirectionBrandWithModelsDTO(
                allParams);
    }
    ...
    public List<BrandWithModelsDTO>
    findByNotNullBrandWithModelsDTO(
    ...
    public List<BrandWithModelsDTO>
    findLessThanBrandWithModelsDTO(
    ...
    public List<BrandWithModelsDTO>
    findGreaterThanBrandWithModelsDTO(
            @RequestParam Map<String, Number> fieldNumberMap) {
    ...
    findAndSortBrandWithModelsDTO(
        ...
        return brandService.findAndSortBrandWithModelsDTO(
                fieldDirectionMap, fieldCriteriaMap);
    }

    @GetMapping("/findContain")
    public List<BrandWithModelsDTO>
    findContainBrandWithModelsDTO(
