...
class CarServiceTest {
  ...
  private final List<CarWithModelCategoryPriceHistoryBrandDTO> carWithModelCategoryPriceHistoryBrandDTOList;
  ...
  public CarServiceTest() {
    ...
    carWithModelCategoryPriceHistoryBrandDTOList.add(new CarWithModelCategoryPriceHistoryBrandDTO());
