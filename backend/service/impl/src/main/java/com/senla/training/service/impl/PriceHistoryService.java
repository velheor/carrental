...
public class PriceHistoryService implements IPriceHistoryService {
    ...
    @Override
    public PriceHistoryWithCarModelBrandDTO findByIdPriceHistoryWithCarModelBrandDTO(
            int id) {
    ...
    findOneByCriteriaPriceHistoryWithCarModelBrandDTO(
    ...
    @Override
    public List<PriceHistoryWithCarModelBrandDTO>
    findAllByCriteriaPriceHistoryWithCarModelBrandDTO(
            Map<String, Object> fieldCriteriaMap) {
        return objectMapperUtils.mapAll(
    ...
    @Override
    public List<PriceHistoryWithCarModelBrandDTO>
    findByNotNullPriceHistoryWithCarModelBrandDTO(List<String> fields) {
        return objectMapperUtils.mapAll(
    ...
    @Override
    public List<PriceHistoryWithCarModelBrandDTO>
    findByNullPriceHistoryWithCarModelBrandDTO(List<String> fields) {
        return objectMapperUtils.mapAll(
    ...
    @Override
    public List<PriceHistoryWithCarModelBrandDTO>
    findLessThanPriceHistoryWithCarModelBrandDTO(Map<String, Number> fieldNumberMap) {
        return objectMapperUtils.mapAll(
    ...
    @Override
    public List<PriceHistoryWithCarModelBrandDTO>
    findGreaterThanPriceHistoryWithCarModelBrandDTO(Map<String, Number> fieldNumberMap) {
        return objectMapperUtils.mapAll(
    ...
    @Override
    public List<PriceHistoryWithCarModelBrandDTO>
    findAndSortPriceHistoryWithCarModelBrandDTO(
    ...
    @Override
    public List<PriceHistoryWithCarModelBrandDTO>
    findContainPriceHistoryWithCarModelBrandDTO(Map<String, String> fieldStringMap) {
        return objectMapperUtils.mapAll(
    ...
    public PriceHistoryDTO create(PriceHistoryDTO entityDTO) {
        return objectMapperUtils.map(
                priceHistoryDAO.create(objectMapperUtils.map(entityDTO, PriceHistory.class)), PriceHistoryDTO.class);
    }

    @Override
    public PriceHistoryDTO update(PriceHistoryDTO entityDTO) {
        return objectMapperUtils.map(
                priceHistoryDAO.update(objectMapperUtils.map(entityDTO, PriceHistory.class)), PriceHistoryDTO.class);
    }
