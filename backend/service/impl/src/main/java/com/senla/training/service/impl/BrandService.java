...
public class BrandService implements IBrandService {
    ...
    @Override
    public BrandWithModelsDTO findByIdBrandWithModelsDTO(
            int id) {
        return objectMapperUtils.map(
                brandDAO.findByIdBrandWithModels(id),
                BrandWithModelsDTO.class);
    }

    @Override
    public List<BrandWithModelsDTO>
    findAllAndSortWithDirectionBrandWithModelsDTO(
    ...
    findOneByCriteriaBrandWithModelsDTO(
            Map<String, Object> fieldCriteriaMap) {
        return objectMapperUtils.map(
                brandDAO.findOneByCriteriaBrandWithModels(fieldCriteriaMap),
                BrandWithModelsDTO.class);
    }

    @Override
    public List<BrandWithModelsDTO>
    findAllByCriteriaBrandWithModelsDTO(
            Map<String, Object> fieldCriteriaMap) {
        return objectMapperUtils.mapAll(
                brandDAO.findAllByCriteriaBrandWithModels(fieldCriteriaMap),
                BrandWithModelsDTO.class);
    }

    @Override
    public List<BrandWithModelsDTO>
    findByNotNullBrandWithModelsDTO(List<String> fields) {
        return objectMapperUtils.mapAll(
                brandDAO.findByNotNullBrandWithModels(fields),
                BrandWithModelsDTO.class);
    }

    @Override
    public List<BrandWithModelsDTO>
    findByNullBrandWithModelsDTO(List<String> fields) {
        return objectMapperUtils.mapAll(
                brandDAO.findByNullBrandWithModels(fields),
                BrandWithModelsDTO.class);
    }

    @Override
    public List<BrandWithModelsDTO>
    findLessThanBrandWithModelsDTO(Map<String, Number> fieldNumberMap) {
        return objectMapperUtils.mapAll(
                brandDAO.findLessThanBrandWithModels(fieldNumberMap),
                BrandWithModelsDTO.class);
    }

    @Override
    public List<BrandWithModelsDTO>
    findGreaterThanBrandWithModelsDTO(Map<String, Number> fieldNumberMap) {
        return objectMapperUtils.mapAll(
                brandDAO.findGreaterThanBrandWithModels(fieldNumberMap),
                BrandWithModelsDTO.class);
    }

    @Override
    public List<BrandWithModelsDTO>
    findAndSortBrandWithModelsDTO(
    ...
    @Override
    public List<BrandWithModelsDTO>
    findContainBrandWithModelsDTO(Map<String, String> fieldStringMap) {
        return objectMapperUtils.mapAll(
                brandDAO.findContainBrandWithModels(fieldStringMap),
                BrandWithModelsDTO.class);
    }
