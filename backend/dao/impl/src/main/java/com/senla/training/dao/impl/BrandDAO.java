...
public class BrandDAO extends EntityGraphAbstractDAO<Brand> implements IBrandDAO {
    ...
    @Override
    public Brand findOneByCriteriaBrandWithModel(
    ...
    @Override
    public List<Brand> findAllByCriteriaBrandWithModel(
            Map<String, Object> fieldCriteriaMap) {
        super.setEntityGraphName("brandWithModel");
    ...
    @Override
    public List<Brand> findLessThanBrandWithModel(
    ...
    @Override
    public List<Brand> findGreaterThanBrandWithModel(
            Map<String, Number> fieldNumberMap) {
        super.setEntityGraphName("brandWithModel");
    ...
    @Override
    public List<Brand> findContainBrandWithModel(
