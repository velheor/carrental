...
public class RentDAO extends EntityGraphAbstractDAO<Rent> implements IRentDAO {
  ...
  @Override
  public List<Rent> sortWithDirectionRentWithUserStatusHistoryCar(
  ...
  @Override
  public List<Rent> findAllByCriteriaRentWithUserStatusHistoryCar(
  ...
  @Override
  public List<Rent> findAndSortRentWithUserStatusHistoryCar(
