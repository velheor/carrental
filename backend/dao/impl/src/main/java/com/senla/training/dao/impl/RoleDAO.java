...
public class RoleDAO extends EntityGraphAbstractDAO<Role> implements IRoleDAO {
    ...
    @Override
    public Role findOneByCriteriaRoleWithUsers(
    ...
    @Override
    public List<Role> findAllByCriteriaRoleWithUsers(
            Map<String, Object> fieldCriteriaMap) {
        super.setEntityGraphName("roleWithUsers");
    ...
    @Override
    public List<Role> findLessThanRoleWithUsers(
    ...
    @Override
    public List<Role> findGreaterThanRoleWithUsers(
            Map<String, Number> fieldNumberMap) {
        super.setEntityGraphName("roleWithUsers");
    ...
    @Override
    public List<Role> findContainRoleWithUsers(
