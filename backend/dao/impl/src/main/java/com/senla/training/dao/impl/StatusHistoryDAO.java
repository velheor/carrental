...
@Repository
public class StatusHistoryDAO extends EntityGraphAbstractDAO<StatusHistory> implements IStatusHistoryDAO {
    @Override
    ...
    @Override
    public List<StatusHistory> findLessThanStatusHistoryWithRent(
    ...
    @Override
    public List<StatusHistory> findContainStatusHistoryWithRent(
