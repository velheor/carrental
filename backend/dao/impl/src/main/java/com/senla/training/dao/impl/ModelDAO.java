...
public class ModelDAO extends EntityGraphAbstractDAO<Model> implements IModelDAO {
    ...
    @Override
    public Model findOneByCriteriaModelWithBrand(
    ...
    @Override
    public List<Model> findAllByCriteriaModelWithBrand(
            Map<String, Object> fieldCriteriaMap) {
        super.setEntityGraphName("modelWithBrand");
    ...
    @Override
    public List<Model> findLessThanModelWithBrand(
    ...
    @Override
    public List<Model> findGreaterThanModelWithBrand(
            Map<String, Number> fieldNumberMap) {
        super.setEntityGraphName("modelWithBrand");
    ...
    @Override
    public List<Model> findContainModelWithBrand(
