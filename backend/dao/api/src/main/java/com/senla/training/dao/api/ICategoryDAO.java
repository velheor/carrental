...
public interface ICategoryDAO extends IGenericDAO<Category> {
    ...
    Category findOneByCriteriaCategoryWithCategoriesCarsModelBrand(Map<String, Object> fieldCriteriaMap);
    ...
    List<Category> findLessThanCategoryWithCategoriesCarsModelBrand(Map<String, Number> fieldNumberMap);
    ...
    List<Category> findContainCategoryWithCategoriesCarsModelBrand(Map<String, String> fieldStringMap);
}
